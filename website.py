...
def build_components():
    ...
    return NAVBAR,data[0]["unit"],data[0]["url"],data[0]["pdf"],PDF_LIST
...
def load_website():
    try:
        NAVBAR,ACTIVE_LABEL,ACTIVE_PAGE,ACTIVE_PDF,PDF_LIST = build_components()
        return render_template("index.html",NAVBAR=NAVBAR,ACTIVE_LABEL=ACTIVE_LABEL,ACTIVE_PAGE=ACTIVE_PAGE,ACTIVE_PDF=ACTIVE_PDF,PDF_LIST=PDF_LIST)
    except:
